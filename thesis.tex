...
%ABOUT STORAGE DRIVERS \cite{aboutstoragedrivers}
...
Viene fornita l'immagine di base ufficiale di Node-RED scaricabile dalla repository di DockerHub.
\clearpage
...
\begin{tabular}{cc}
 ...
 %Aggiungi le altre due immagini 
\end{tabular}
\end{figure}
