...
È stato progettato per un basso impatto a livello di banda e di risorse. I client si iscrivono ad un \texttt{topic}, ossia un identificatore che si riferisce ad un dato ben preciso (ad esempio \texttt{sensor/temperature}).
