...
\textbf{FOTO DEL MENU IMPOSTAZIONI NOME NODO E DISPOSITIVO, SEMPLIFICAZIONE PER L'UTENTE}
...
Il nodo Alive quando viene caricato dal runtime esegue una chiamata alle API di SeismoCloud e ottiene tutti i dati dei sismometri che sono registrati nel gruppo selezionato per utilizzarli nei controlli e nella condivisione con gli altri nodi.
