...
% ======================================= ABSTRACT ================================================
\begin{abstract}
L'oggetto dello studio della tesi è la progettazione e la creazione di un sistema di End User Development per \textbf{SeismoCloud}. Uno strumento di EUD (Sviluppo dell'utente finale) consente agli utenti di programmare delle azioni che avverrano in modo automatico alla verifica di determinate condizioni, senza conoscere un linguaggio di programmazione o avere elevata conoscenza informatica.

SeismoCloud è un sistema di Earthquake Early Warning, cioè una rete di sismometri e acceleromentri a basso costo distribuiti su un determinato territorio (in questo caso l'Italia) che consente di avvertire le persone interessate quando è in corso una possibile scossa sismica o addirittura, data l'elevata velocità della rete, prima che il sisma le abbia raggiunte.

Dato che l'End User Development è pensato per un pubblico di non esperti, il lavoro si concentra principalmente sulla facilità d'uso dell'applicativo e sulla minima conoscenza informatica durante la configurazione delle azioni da programmare.
Quindi è necessario un lavoro di astrazione dai tecnicismi della materia semplificando in maniera più forte possibile le funzionalità offerte.
Questo però non deve contrastare le potenzialità del sistema, gli utenti devono avere \textbf{completa libertà nelle scelte} da loro ideate, quindi i più esperti devono comunque riuscire a programmare delle azioni complesse.
...
La tesi è suddivisa in quattro macrocapitoli: la \textbf{progettazione} del sistema e le scelte effettuate in fase di disegno del progetto; l'\textbf{implementazione} delle funzionalità inserite all'interno del sistema concentrata sull'astrazione e sulla semplificazione del processo di automatizzazione dei compiti; uno \textbf{studio della sicurezza} del sistema finalizzata alla ricerca ed alla risoluzione, \textit{ove possibile}, di vulnerabilità; una \textbf{fase di test} per assicurare l'esito positivo del lavoro e/oppure sottolineare eventuali criticità ancora presenti.
...
\label{fig:ipocentro}
\centering
\includegraphics[width=0.55\textwidth]{Chapter-1/ipo-epi-centro.png}
\end{figure}
...
\end{quoting}
Quindi, queste tipologie di sistemi permettono a utenti finali (diretti utilizzatori del sistema) di collegare dati e servizi in un modo logico e sviluppare funzionalità ad hoc precedentemente non disponibili.
Ad esempio, si può ricevere un messaggio automatico tramite Telegram ogni volta che il mio sismometro vibra.
Oppure, ricevere una notifica push sul proprio cellulare quando $n$ sismometri rilevano una vibrazione nello stesso momento, o meglio ancora, allertare tutti gli utenti in un gruppo.
È facile intuire che queste tipologie di automazione sono 
molto utili per un utente non esperto, soprattutto nell'ambito SeismoCloud, dove la community è un fattore cardine dell'applicativo.
...
\clearpage
Questo lavoro di tirocinio è stato riassunto in un paper creato insieme al Professore Emanuele Panizzi ed il Dottorando Enrico Bassetti, il quale è stato sottomesso, accettato e presentato al Workshop EMPATHY 2020 (Empowering People in Dealing with Internet of Things) \cite{paper}.
\begin{figure}[hbt]
    \centering
    \includegraphics[width=1\textwidth]{Chapter-1/paper.jpg}
    \label{fig:paper}
\end{figure}
...
\label{fig:drawio}
\includegraphics[width=1\textwidth]{Chapter-2/drawio.png}
\end{figure}
...
\includegraphics[width=1\textwidth]{Chapter-2/node-red-flows-1.jpg}
\end{figure}
...
\includegraphics[width=1\textwidth]{Chapter-2/node-red-flows-2.jpg}
\end{figure}
...
\includegraphics[width=1\textwidth]{Chapter-2/node-red-flows-4.jpg}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=1\textwidth]{Chapter-2/node-red-flows-3.jpg}
\end{figure}
...
\begin{figure}[ht]
\includegraphics[width=1\textwidth]{Chapter-2/container-layers.jpg}
\end{figure}
...
\includegraphics[width=1\textwidth]{Chapter-2/vm-c.jpg}
\end{figure}
...
\begin{figure}
    \includegraphics[width=1\textwidth]{Chapter-2/docker-vm-1.jpg}
...
\begin{figure}
\begin{tabular}{cc}
  \includegraphics[width=0.5\textwidth]{Chapter-2/docker-vm-2.jpg} &   \includegraphics[width=0.5\textwidth]{Chapter-2/docker-vm-3.jpg} \\
 \includegraphics[width=0.5\textwidth]{Chapter-2/docker-vm-4.jpg} &   \includegraphics[width=0.5\textwidth]{Chapter-2/docker-vm-5.jpg} \\
 \includegraphics[width=0.5\textwidth]{Chapter-2/docker-vm-6.jpg} &   \includegraphics[width=0.5\textwidth]{Chapter-2/docker-vm-7.jpg} \\
\end{tabular}
\end{figure}
...
\begin{figure}[ht]
\includegraphics[width=0.9\textwidth]{Chapter-2/architettura-seismocloud2.png}
\end{figure}
...
\begin{figure}[ht]
\label{legacy1}
\includegraphics[width=1\textwidth]{Chapter-3/eud-legacy-1.jpg}
\end{figure}
...
\begin{figure}[ht]
\label{legacy2}
\includegraphics[width=1\textwidth]{Chapter-3/eud-legacy-2.jpg}
\end{figure}
\clearpage
...
\begin{figure}[hbt]
    \includegraphics[width=1\textwidth]{Chapter-3/mqtt-legacy-1.jpg}
...
\begin{figure}[hbt]
    \includegraphics[width=1\textwidth]{Chapter-3/mqtt-legacy-2.jpg}
...
\begin{figure}[ht]
    \includegraphics[width=1\textwidth]{Chapter-3/lower-case-1.jpg}
    \label{fig:lower-case-1}
\end{figure}

\begin{figure}[ht]
    \includegraphics[width=1\textwidth]{Chapter-3/lower-case-2.jpg}
...
\begin{figure}[ht]
    \includegraphics[width=1\textwidth]{Chapter-3/menu.jpg}
...
\begin{figure}[ht]
    \includegraphics[width=1\textwidth]{Chapter-3/rssi-1.jpg}
    \label{fig:rssi-1}
\end{figure}
\begin{figure}[ht]
    \includegraphics[width=1\textwidth]{Chapter-3/rssi-2.jpg}
    \label{fig:rssi-2}
\end{figure}
...
\begin{figure}[ht]
    \includegraphics{Chapter-3/api-seismo.jpg}
...
\begin{figure}[ht]
    \includegraphics[width=1\textwidth]{Chapter-4/exec.jpg}
    \label{fig:exec}
\end{figure}
...
\begin{figure}[ht]
    \includegraphics[width=1\textwidth]{Chapter-4/install.jpg}
...
\begin{figure}[ht]
    \includegraphics[width=1\textwidth]{Chapter-4/env_var_1.jpg}
...
\begin{itemize}
    ...
    \begin{figure}[ht]
        \centering
        \includegraphics[width=1\textwidth]{Chapter-5/test-1.jpg}
        \label{fig:test1}
    \end{figure}
    ...
    \begin{figure}[hbt]
        \centering
        \includegraphics[width=1\textwidth]{Chapter-5/test-2.jpg}
        \label{fig:test1}
    \end{figure}
    ...
    \begin{figure}[hbt]
        \centering
        \includegraphics[width=1\textwidth]{Chapter-5/test-3.jpg}
        \label{fig:test1}
    \end{figure}
    ...
    \begin{figure}[ht]
        \centering
        \includegraphics[width=1\textwidth]{Chapter-5/test-4.jpg}
        \label{fig:test1}
    \end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1\textwidth]{Chapter-5/bssid-help.jpg}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1\textwidth]{Chapter-5/tweetINGV.jpg}
    \label{fig:tweetINGV}
\end{figure}
...
\\
Ringrazio in primis la mia famiglia che mi ha sempre dato una mano e che ho trovato al mio fianco nei momenti più difficili.
Ringrazio vivamente il Prof. Emanuele Panizzi che mi ha seguito constantemente in questo percorso facendomi crescere sia dal punto di vista tecnico, sia personale.
\\
Non posso non ringraziare Enrico per tutte le volte che mi ha aiutato quando avevo difficoltà nel proseguire con il lavoro.
\\
...
\bibitem{paper}
    \textbf{Simplify Node-RED for End User Development in SeismoCloud}
    \\
