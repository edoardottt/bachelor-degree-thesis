...
Dato che Node-RED utilizza NodeJS come runtime, il linguaggio utilizzato è Javascript e la libreria che aggiunge funzionalità riguardanti MQTT è MQTT.js (\href{https://github.com/mqttjs}{https://github.com/mqttjs}).
La scelta è motivata dal codice open-source, dalla attiva community di utenti e sviluppatori e dalla maturità del progetto.
...
\begin{itemize}
    \item node-red-contrib-get-seismometer-info (Input: 1, Output: 1): 
    \item node-red-contrib-list-earthquakes (Input: 1, Output: 1): 
    \item node-red-contrib-get-all-seismometers-in-group (Input: 1, Output: 1):
    \item node-red-contrib-get-weekly-ranking-for-all-devices-in-group (Input: 1, Output: 1):
    \item node-red-contrib-general-statistics-for-groups (Input: 1, Output: 1):
    \item node-red-contrib-weekly-statistics-for-groups (Input: 1, Output: 1):
    \item node-red-contrib-get-activity-intervals-for-seismometers (Input: 1, Output: 1):
    \item node-red-contrib-get-statistics-for-active-seismometers-in-the-latest-minutes (Input: 1, Output: 1):
    \item node-red-contrib-get-all-perceptible-earthquakes (Input: 1, Output: 1):
\end{itemize}
