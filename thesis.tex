...
\\
QUI SE POSSIBILE INSERIRE FOTO DEL PAPER DOCKER VS VM (BIBLIO n'6).
...
\\
Se, mentre tutti i servizi sono in esecuzione, voglio modificare lo stato di uno solo posso farlo con i comandi di Docker.
\clearpage
