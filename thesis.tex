...
\end{figure}
Sono state comparate le prestazioni della CPU, un test di compressione dati (utilizzando 7-Zip con un file di 10GB), le prestazioni della memoria RAM (utilizzando RAM speed/SMP) e un caso particolare. Come caso particolare è stato utilizzato Eigth Queen, una simulazione di un problema del gioco degli scacchi. 
\begin{figure}
\begin{tabular}{cc}
