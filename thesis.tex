...
I sismometri possono essere costruiti se si ha capacità di elettronica di base, altrimenti viene utilizzato il sensore interno di uno smartphone. \\
...
I \textbf{sismometri mobili} invece utilizzano la applicazione per smartphone, abilitando l'accelerometro interno del telefono, per rilevare vibrazioni. Devono essere appoggiati su un piano, per esempio un tavolo. \\
...
Per i messaggi di invio e ricezione dei sismometri e per tutti i dati prodotti da essi per le statistiche viene utilizzato lo stile architetturale \textbf{REST} (REpresentational State Transfer). \\
I dati possono essere visualizzati in vari modi. \\
Tramite l'app mobile (disponibile in Android e iOS) si possono visualizzare la lista dei sismometri presenti, una mappa aggiornata in tempo reale con i sismometri attivi e i terremoti recenti, una lista di terremoti con relativa magnitudo, posizione e profondità dell'ipocentro e alcuni informazioni utili. \\
...
Nella dashboard personale è possibile visualizzare due grafici he mostrano il tempo di utilizzo assoluto e settimanale di ogni sismometro attivo.
...
\subsection{Potere della community}
