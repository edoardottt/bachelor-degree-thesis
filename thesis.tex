...
li invia in maniera sicura, lo stesso che viene utilizzato per cifrare i dati da HTTP in HTTPS.
...
\begin{figure}[hbt]
    \centering
    \includegraphics[width=0.9\textwidth]{relazione-tirocinio/Chapter-5/paper.jpg}
    \label{fig:paper}
\end{figure}
