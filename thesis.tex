...
Sarebbe molto più utile lasciare completa libertà all'utente (sotto alcune restrizioni di sicurezza) integrando il sismometro con l'ambiente locale. 
\\
...
\\
La soluzione a questo bisogno dovrebbe essere: facilmente utilizzabile, sicura, affidabile e performante.
\clearpage
