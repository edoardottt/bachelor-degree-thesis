...
Docker automatizza il deployment di applicazioni software incapsulando i programmi all'interno di contenitori astraendo dal sistema operativo Linux sottostante.
Esso isola6
Attraverso un file chiamato \textit{Dockerfile} viene descritto come 
\clearpage
