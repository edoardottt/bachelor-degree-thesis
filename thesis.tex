...
COPY common common
COPY seismometer-data seismometer-data
COPY api-seismocloud api-seismocloud

USER 0
RUN chown -R node-red seismometer-data \
    && chown -R node-red api-seismocloud
USER node-red
